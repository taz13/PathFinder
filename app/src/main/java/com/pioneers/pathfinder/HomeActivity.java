...
import com.pioneers.pathfinder.util.SystemUiHider;
...
public class HomeActivity extends Activity {
    ...
    private static final String START = "startPlace";
    private static final String DEST = "destPlace";
     ...
     */
    View.OnTouchListener findPathTouchListener;
    /**
    ...
    public HomeActivity() {
        findPathTouchListener = new View.OnTouchListener() {
            @Override
    ...
    public void showPath(View view) {
        ...
        String startPlace = startPlaceText.getText().toString();
        String destPlace = destPlaceText.getText().toString();
        intent.putExtra(START, startPlace);
        intent.putExtra(DEST, destPlace);
